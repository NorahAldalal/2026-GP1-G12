...
$adminLinks = [
    ...
    ['href' => 'admin-lamp-offset.php', 'key' => 'offset',   'label' => 'Offsets',   'icon' => '◌'],
...
<nav class="siraj-nav">
  ...
  <div class="nav-right">
    <button class="theme-toggle" id="theme-toggle" title="Toggle theme">
      <span class="t-dark">✦ Dark</span>
      <span class="t-light" style="display:none;">☀ Light</span>
    </button>
    ...
    <a href="profile.php"
       ...
       title="<?= htmlspecialchars($navName) ?>">
