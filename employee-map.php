...
<div class="map-layout">
  ...
  <div class="map-sidebar">
    ...
    <!-- Mini Bar Chart -->
    <div style="padding:14px 14px 6px;border-top:1px solid rgba(126,200,227,.10);">
    ...
    <!-- Export (employee sees only their area) -->
    <div style="padding:12px 14px;border-top:1px solid rgba(126,200,227,.10);">
      <div class="chart-label">Export Analytics</div>
      <a href="analytics-export.php?area_id=<?= $areaId ?>" class="view-more-btn" style="text-decoration:none;display:flex;align-items:center;gap:6px;justify-content:center;">
        ↓ Export My Area (.csv)
      </a>
    </div>
...
<div class="analytics-modal" id="analytics-modal">
  <div class="analytics-modal-box">
    ...
    <div class="modal-atitle"><?= htmlspecialchars($area['AreaName']) ?> — Lighting Analysis</div>
    <p class="modal-asub">Weekly average ambient light readings for your area.</p>
    ...
    <div style="display:flex;justify-content:flex-end;">
      <a href="analytics-export.php?area_id=<?= $areaId ?>" class="btn btn-accent btn-sm">↓ Export My Area (.csv)</a>
    </div>
  </div>
</div>
